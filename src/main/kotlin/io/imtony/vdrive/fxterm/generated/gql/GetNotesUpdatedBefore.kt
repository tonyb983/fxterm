...
const val GET_NOTES_UPDATED_BEFORE: String =
    "query GetNotesUpdatedBefore(${'$'}time: LocalDateTime!) {\r\n  getNotesUpdatedBefore(time: ${'$'}time) {\r\n    id\r\n    title\r\n    content\r\n    tags\r\n    created\r\n    updated\r\n  }\r\n}"

class GetNotesUpdatedBefore(
  private val graphQLClient: GraphQLWebClient
) {
  suspend fun execute(variables: GetNotesUpdatedBefore.Variables,
      requestBuilder: WebClient.RequestBodyUriSpec.() -> Unit = {}):
      GraphQLResponse<GetNotesUpdatedBefore.Result> =
      graphQLClient.execute(GET_NOTES_UPDATED_BEFORE, "GetNotesUpdatedBefore", variables,
      requestBuilder)

  data class Variables(
    val time: GetNotesUpdatedBefore.LocalDateTime
  )
  ...
  data class Note(
     ...
     */
    val id: GetNotesUpdatedBefore.UUID,
    /**
     ...
     */
    val created: GetNotesUpdatedBefore.LocalDateTime,
    /**
     * The LocalDateTime of when the Note was last updated.
     */
    val updated: GetNotesUpdatedBefore.LocalDateTime
  )

  data class Result(
    val getNotesUpdatedBefore: List<GetNotesUpdatedBefore.Note>
  )
}
