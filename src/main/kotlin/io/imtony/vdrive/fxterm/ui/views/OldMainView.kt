...
import io.imtony.vdrive.fxterm.AppFonts.Consola
import io.imtony.vdrive.fxterm.FontLocker
 ...
 */
class OldMainView : View("Main View"), CoroutineScope {
  ...
  private val consoleFont by lazy { FontLocker.getFont(Consola, 12) }
